<div class="contenu">
    <div class="contenu_interne">
        ...
        <div class="encadre">
            <p>Etat : <?php echo $libEtat?> depuis le <?php echo $dateModif?> <br> Montant validé : <?php echo $montantValide?>€ par le chef de Pole <?php echo $nomDuComptable . " " . $prenomDuComptable; ?></p>
                ...
                foreach ($lesFraisHorsForfait as $unFraisHorsForfait){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $messageEnvoiJustificatif = "(*) Envoi de justificatif admis jusqu'au 09 du mois suivant la déclaration des frais. Vous pouvez encore télécharger des justificatif pour ce mois. Téléchargement limité à 3fichiers au maximum pour un frais";
                        ...
                        <td>
                            ...
                            if ($numerotationJustificatif == 0 || $numerotationJustificatif < 3){
                                ...
                                <?php
                                    ...
                                    $messageEnvoiJustificatif = "Envoi de justificatif admis jusqu'au 09 du mois suivant la déclaration des frais. Vous n'avez plus la possibilité de télécharger de justificatif pour ce mois.";
                                }
                            }
                            ?>
                        </td>
