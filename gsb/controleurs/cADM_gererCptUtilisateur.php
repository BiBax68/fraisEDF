...
switch($action){
    ...
    case 'ajouterCptUtilisateur':{
        $lesCatEmploye = $pdo->getLesDonnéesFixesForm("gsbgf_typeemploye","libelleTypeEmploye");
        $lesCatFraisKm = $pdo->getLesDonnéesFixesForm("gsbgf_typevehicule","libelleTypeVehicule");
        $localisation = $pdo->getLesDonnéesFixesForm("gsbgf_localisation","libelleVille");
